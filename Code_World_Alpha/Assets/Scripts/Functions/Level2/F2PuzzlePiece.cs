...
public class F2PuzzlePiece : MonoBehaviour
{
    ...
    private F2PuzzleManager f2puzzleManager;
    ...
    void Awake()
    {
        ...
        f2puzzleManager = FindObjectOfType<F2PuzzleManager>();
